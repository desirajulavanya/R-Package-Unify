...
The goal of `panelbuild` is to help users identify these issues before
estimation.
...
`panelbuild` is designed to provide a transparent and reproducible
workflow for panel-data quality assurance.
